...
struct Localizable {
    ...
    static let chooseOpenWay: LocalizedStringKey = "Choose open way"
    static let embeddedSafari: LocalizedStringKey = "Embedded Safari"
    static let universalLinks: LocalizedStringKey = "Universal Links";
